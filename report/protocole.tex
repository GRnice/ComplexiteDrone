...
\begin{figure}[!h]
        ...
        \begin{tikzpicture}[
                ...
                \node [intg] (kp)  {chef};
                \node [int]  (ki1) [node distance=1.5cm and -1cm,below left=of kp] {Id};
                \node [int]  (ki11) [node distance=1.5cm and -1cm,below =of ki1] {UId};
                \node [int]  (ki12) [node distance=1.5cm and -1cm,below =of ki11] {(UId,Num)};
                \node [int]  (ki2) [node distance=1.5cm and -1cm,below right=of kp] {0};
                \node [int]  (ki21) [node distance=1.5cm and -1cm,below=of ki2] {chef};
                \node [int]  (ki22) [node distance=1.5cm and -1cm,below=of ki21] {Id};
                \node [int]  (ki23) [node distance=1.5cm and -1cm,below=of ki22] {UId};
                \node [int]  (ki24) [node distance=1.5cm and -1cm,below=of ki23] {(UId,Num)};
                \node [int]  (ki3)  [node distance=1.5cm and -1cm, below left=of ki24] {direction};
                \node [int]  (ki4)  [node distance=1.5cm and -1cm, below right=of ki24] {(vitesse, temps)};
        ...
        \end{tikzpicture}
        \caption{Déroulement des communications}
        \label{fig:Comm}
\end{figure}
